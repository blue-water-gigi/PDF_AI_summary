...
readonly class CustomerSubscriptionCreatedHandler implements StripeEventsHandlerInterface
{
    ...
    {
        return StripeEventType::CustomerSubscriptionCreated->value === $event->getType();
    }
}
