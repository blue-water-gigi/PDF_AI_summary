...
readonly class PaymentIntentFailedHandler implements StripeEventsHandlerInterface
{
    ...
    {
        return StripeEventType::PaymentIntentPaymentFailed->value === $event->getType();
    }
}
